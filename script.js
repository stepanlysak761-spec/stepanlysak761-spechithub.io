document.addEventListener('DOMContentLoaded', () => {
    const historyFacts = [
        ...
        "Двигун V6 є структурним елементом шасі.",
        "Монокок виготовлений повністю з карбонового волокна.",
        "У 2024 році Ferrari виграла Ле-Ман вдруге поспіль.",
        ...
        "Система гальм Brake-by-Wire заряджає батарею при гальмуванні."
    ];
    ...
    const typeText = "ACCESSING CORE... Ferrari 499P: Гібридний домінант. Повернення до витоків швидкості та перемог у Маранелло.";
    let i = 0;
    function typeEffect() {
